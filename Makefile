...
MODULES = plocamlu
REGRESS = plocaml_call plocaml_spi plocaml_void plocaml_do plocaml_spi_nested plocaml_composite plocaml_gd_sd plocaml_global plocaml_import plocaml_newline plocaml_params plocaml_ereport plocaml_error plocaml_drop
